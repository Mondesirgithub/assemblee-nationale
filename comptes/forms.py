...
class InscriptionForm(UserCreationForm):
	nom = forms.CharField(widget=forms.EmailInput({'class':'form-control'}), label="Nom(s)")
	prenom = forms.CharField(widget=forms.EmailInput({'class':'form-control'}), label="Prenom(s)")
